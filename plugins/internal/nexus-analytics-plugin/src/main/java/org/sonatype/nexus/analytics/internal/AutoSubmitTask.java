  ...
  extends NexusTaskSupport
{
  ...
  public static final String ID = "AutoSubmitTask";
  //public static final String ID = AnalyticsPlugin.ID_PREFIX + ".autosubmit";

  private final EventExporter eventExporter;

  @Inject
  public AutoSubmitTask(final EventExporter eventExporter) {
